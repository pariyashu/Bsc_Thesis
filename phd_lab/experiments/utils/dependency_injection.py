...
import experiments.utils.config

_TARGET = {
    'model': experiments.utils.config.MODEL_REGISTRY,
    'dataset': experiments.utils.config.DATASET_REGISTRY,
    'optimizer': experiments.utils.config.OPTIMIZER_REGISTRY,
    'metric': experiments.utils.config.METRICS_REGISTRY
}
