...
def vgg16_XXS_d1(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=1), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D1"
    return model

def vgg16_XXS_d2(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=2), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D2"
    return model

def vgg16_XXS_d3(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=3), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D3"
    return model

def vgg16_XXS_d4(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=4), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D4"
    return model

def vgg16_XXS_d5(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=5), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D5"
    return model

def vgg16_XXS_d6(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['DXXS'],dilation=6), final_filter=64, **kwargs)
    model.name = "VGG16_XXS_D6"
    return model
...
def vgg11_XXS_d1(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=1), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D1"
    return model


def vgg11_XXS_d2(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=2), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D2"
    return model


def vgg11_XXS_d3(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=3), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D3"
    return model


def vgg11_XXS_d4(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=4), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D4"
    return model

def vgg11_XXS_d5(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=5), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D5"
    return model

def vgg11_XXS_d6(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['AXXS'],dilation=6), final_filter=64, **kwargs)
    model.name = "VGG11_XXS_D6"
    return model
...
def vgg13_XXS_d5(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=5), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D5"
    return model
...
def vgg13_XXS_d1(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=1), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D1"
    return model

def vgg13_XXS_d2(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=2), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D2"
    return model

def vgg13_XXS_d3(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=3), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D3"
    return model

def vgg13_XXS_d4(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=4), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D4"
    return model

def vgg13_XXS_d6(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['BXXS'],dilation=6), final_filter=64, **kwargs)
    model.name = "VGG13_XXS_D6"
    return model
...
def vgg19_XXS_d1(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=1), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D1"
    return model

def vgg19_XXS_d2(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=2), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D2"
    return model

def vgg19_XXS_d3(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=3), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D3"
    return model

def vgg19_XXS_d4(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=4), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D4"
    return model

def vgg19_XXS_d5(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=5), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D5"
    return model

def vgg19_XXS_d6(*args, **kwargs):
    """VGG 16-layer model (configuration "D")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG(make_layers(cfg['EXXS'],dilation=6), final_filter=64, **kwargs)
    model.name = "VGG19_XXS_D6"
    return model
